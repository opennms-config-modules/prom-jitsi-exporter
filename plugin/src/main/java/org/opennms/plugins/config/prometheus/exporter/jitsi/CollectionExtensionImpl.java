...
public class CollectionExtensionImpl implements SnmpCollectionExtension {

    private final ClasspathSnmpDataCollectionLoader snmpDataCollectionLoader =
            new ClasspathSnmpDataCollectionLoader(CollectionExtensionImpl.class,
                    "prometheus-jitsi-exporter.xml");
